...
hl("CursorLineNr", { fg = c.foreground })
...
hl("FloatBorder", { fg = c.floatBorder, bg = c.background })
hl("FloatFooter", { fg = c.floatBorder, bg = c.background })
hl("FloatTitle", { fg = c.floatBorder, bg = c.background })
hl("FoldColumn", { fg = c.comment, bg = c.background })
...
hl("SignColumn", { fg = c.foreground, bg = c.background })
...
hl("StatusLine", { fg = c.foreground, bg = c.background })
hl("StatusLineNC", { fg = c.comment })
hl("StatusLineTerm", { fg = c.foreground, bg = c.background })
...
hl("Terminal", { fg = c.foreground, bg = c.background })
hl("ToolbarButton", { fg = c.background, bg = c.visual })
hl("ToolbarLine", { fg = c.foreground })
hl("Visual", { bg = c.visual })
hl("VisualNOS", { bg = c.comment, undercurl = true })
hl("WarningMsg", { fg = c.warning })
hl("Whitespace", { fg = c.line })
hl("WildMenu", { fg = c.background, bg = c.func })
hl("WinBar", { fg = c.foreground, bg = c.line })
hl("WinBarNC", { fg = c.comment })
hl("WinSeparator", { fg = c.floatBorder })
hl("debugBreakpoint", { fg = c.background, bg = c.operator })
...
hl("@label", { fg = c.keyword })
hl("@markup", { fg = c.foreground })
hl("@markup.heading", { fg = c.keyword })
hl("@markup.italic", { fg = c.foreground, italic = true })
...
hl("@markup.strong", { fg = c.foreground, bold = true })
hl("@markup.underline", { fg = c.foreground, underline = true })
...
hl("@tag.delimiter", { fg = c.foreground })
